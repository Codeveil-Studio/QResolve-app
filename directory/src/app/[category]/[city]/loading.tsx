        ...
        <div style={{
            ...
            <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '2rem' }}>
                ...
                <div style={{ position: 'relative', width: '120px', height: '120px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <div style={{ position: 'absolute', inset: 0, borderRadius: '50%', border: '1.5px solid rgba(52, 211, 153, 0.2)', boxShadow: '0 0 30px rgba(52, 211, 153, 0.1), inset 0 0 30px rgba(52, 211, 153, 0.04)' }} />
                    <div style={{ position: 'absolute', inset: '-2px', borderRadius: '50%', border: '2px solid transparent', borderTopColor: '#34d399', borderRightColor: 'rgba(52, 211, 153, 0.3)', animation: 'loaderSpin 1.4s cubic-bezier(0.4, 0, 0.6, 1) infinite', boxShadow: '0 0 15px rgba(52, 211, 153, 0.3)' }} />
                    ...
                    <div style={{ position: 'relative', zIndex: 2, animation: 'floatAndPulse 2.5s ease-in-out infinite', filter: 'drop-shadow(0 0 16px rgba(52, 211, 153, 0.4))' }}>
                        {/* QResolve logo icon - solid green square with grid */}
                ...
                <div style={{ textAlign: 'center' }}>
                    <div style={{ fontSize: '1.2rem', fontWeight: 600, letterSpacing: '-0.02em', marginBottom: '0.5rem', fontFamily: "'Fraunces', Georgia, serif" }}>
                        ...
                        <span style={{ color: '#e8efe9' }}>Resolve</span>
                    </div>
